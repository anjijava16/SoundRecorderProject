...
public class RecordableClip  {  
    ...
    public void setmFormat(AudioFormat format) {
		this.mFormat = format;
	}     
    public AudioFormat getmFormat() {
		return mFormat;
	}
        ...
        public void run() {  
            try {  
                ...
                while(!mStop) { 
                    ...
                    if (900 < ((System.currentTimeMillis() / 1000) - StartTime)) {
                        break;
                    }
                }  
    ...
    public void save(File f, AudioFileFormat.Type t) throws IOException {  
        if (t.getExtension().equals("raw") || t.getExtension().equals(Type.WAVE.getExtension())) {  //"wav" or "raw"
